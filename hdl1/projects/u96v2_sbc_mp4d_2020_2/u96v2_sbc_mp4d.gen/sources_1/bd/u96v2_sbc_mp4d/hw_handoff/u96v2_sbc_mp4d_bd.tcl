...
proc create_root_design { parentCell } {
  ...
  # Create instance: ImageFilter_0, and set properties
  set block_name ImageFilter
  set block_cell_name ImageFilter_0
  if { [catch {set ImageFilter_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ImageFilter_0 eq "" } {
  ...
  connect_bd_net -net ImageFilter_0_bram_address [get_bd_pins ImageFilter_0/bram_address] [get_bd_pins axi_bram_ctrl_0_bram/addrb]
  connect_bd_net -net ImageFilter_0_bram_data_in [get_bd_pins ImageFilter_0/bram_data_in] [get_bd_pins axi_bram_ctrl_0_bram/dinb]
  connect_bd_net -net ImageFilter_0_bram_wr_en [get_bd_pins ImageFilter_0/bram_wr_en] [get_bd_pins axi_bram_ctrl_0_bram/web]
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins ImageFilter_0/bram_data_out] [get_bd_pins axi_bram_ctrl_0_bram/doutb]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ImageFilter_0/rst_n] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins ImageFilter_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
